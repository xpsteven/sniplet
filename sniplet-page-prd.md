...
**狀態**: Draft v0.8.14(第七輪 audit H-1~H-5 落稿 + Tailwind Play CDN 加回;承接 v0.8.13 可進入實作)
**作者**: XP
**日期**: 2026-04-22
...
**狀態**:v0.8.14 完成(承接 v0.8.13 + 第七輪 audit H-1~H-5 落稿 + Tailwind Play CDN 加回)。交付檔案:`sniplet-page-prd.md` + `SKILL.md`(frontmatter name `sniplet-page-share`)+ `RUNBOOK.md`;`/security`(含 `#advisories` 段落)+ `/.well-known/security.txt` 由 Worker 實作(§10.7 / §10.8)。SKILL.md 對外分發為 apex `/` 與 `/SKILL.md` 永遠 text/plain,repo 維持 private。可進入 implementation 階段。
...
**當前版本:v0.8.14(2026-04-22)** — 第七輪 audit 的 5 個 HIGH(H-1~H-5)落稿 + Tailwind Play CDN 回加 allowlist。
...
## 關鍵安全與營運決策清單(F-1 ~ F-39,v0.8.14 更新)

v0.8.9 的 F-20 / F-22 / F-23(舊)因架構變更已移除;v0.8.10 新增 F-24 ~ F-27;v0.8.11 新增 F-29 ~ F-31、F-11 升 P0;v0.8.12 新增 F-32 ~ F-34;v0.8.14 新增 F-35 ~ F-39(承接第七輪 audit H-1 ~ H-5)。跳號 F-28 保留給 v0.8.11 審計中未觸發的額外發現(目前空)。
