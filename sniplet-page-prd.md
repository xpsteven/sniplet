...
**狀態**: Draft v0.8.11(第五輪審計 — F-11 viewer HMAC 升 v1、SECURITY.md → /security page、CSRF + 雜項 tighten;可進入實作)
**作者**: XP
**日期**: 2026-04-21
...
**狀態**:v0.8.11 完成。交付檔案:`sniplet-page-prd.md` + `sniplet-page-skill.md`(frontmatter name `sniplet-page-share`)+ `RUNBOOK.md`;`/security` page + `/.well-known/security.txt` 由 Worker 實作(規格於 §10.7 / §10.8)。可進入 implementation 階段。
...
**當前版本:v0.8.11(2026-04-21)** — 第五輪審計完成後定稿,F-11 升 v1 + public security policy 改走 web endpoint + 多項 tighten。
...
v0.8.9 的 F-20 / F-22 / F-23(舊)因架構變更已移除;v0.8.10 新增 F-24 ~ F-27;v0.8.11 新增 F-29 ~ F-31、F-11 升 P0。跳號 F-28 保留給 v0.8.11 審計中未觸發的額外發現(目前空)。
